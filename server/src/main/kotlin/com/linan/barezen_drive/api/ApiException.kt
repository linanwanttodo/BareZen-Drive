...
class ApiException(val code: String, val status: HttpStatusCode, override val message: String) : RuntimeException(message) {
    ...
    companion object {
        ...
        fun forbidden(message: String, code: String = ErrorCodes.FORBIDDEN) =
            ApiException(code, HttpStatusCode.Forbidden, message)
        fun rateLimited(message: String = "请求过于频繁") =
            ApiException(ErrorCodes.RATE_LIMITED, HttpStatusCode.TooManyRequests, message)
