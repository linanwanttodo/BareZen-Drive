...
actual object AppPreferences {
    ...
    actual fun get(): AppPrefs = object : AppPrefs {
        ...
        override var albumColumns: Int
            get() = prefs.getInt("album_columns", 4)
            set(v) = prefs.edit().putInt("album_columns", v).apply()
        ...
        override var albumSyncChargingOnly: Boolean
            get() = prefs.getBoolean("album_sync_charging_only", false)
            set(v) = prefs.edit().putBoolean("album_sync_charging_only", v).apply()
