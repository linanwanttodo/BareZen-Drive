...
interface Strings {
    ...
    /** Dismiss the progress dialog and let the batch finish in the transfer centre. */
    val uploadRunInBackground: String
    ...
    val archived: String
    val movedToTrash: String
    val settingsLibrary: String
    val trashTitle: String
    val trashSubtitle: String
    ...
    // Overwrite upload and version history
    val overwriteTitle: String
    fun overwriteMessage(name: String): String
    val actionOverwrite: String
    val actionSkip: String
    fun uploadSkippedNamed(name: String): String
    val versionHistory: String
    val noVersions: String
    val loadingVersions: String
    fun revisionLabel(revision: Long): String
    val versionRestored: String

    // Automatic album backup (Android)
    val settingsBackup: String
    val backupCardTitle: String
    val backupPending: String
    val backupUploading: String
    val backupFailed: String
    val backupExcluded: String
    val backupLastSync: String
    val backupNever: String
    val backupPausedSignedOut: String
    val backupPausedNoNetwork: String
    val backupPausedCharging: String
    val backupPausedBatteryLow: String
    val backupSyncNow: String
    val backupAlbumsTitle: String
    val backupAlbumsHint: String
    val backupAlbumsEmpty: String
    val backupAlbumsReviewTitle: String
    val backupAlbumsReviewHint: String
    val backupAlbumsReviewAll: String
