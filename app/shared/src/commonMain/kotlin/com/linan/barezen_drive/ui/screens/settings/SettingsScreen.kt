...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            GlassSectionHeader(LocalStrings.current.settingsLibrary)
            GlassCard {
                SettingsRow(
                    title = LocalStrings.current.archiveTitle,
                    subtitle = LocalStrings.current.archiveSubtitle,
                    onClick = onOpenArchive,
                    trailing = { Icon(Icons.Default.Archive, contentDescription = null) },
                )
                HorizontalDivider(Modifier.padding(horizontal = 16.dp))
                SettingsRow(
                    title = LocalStrings.current.trashTitle,
                    subtitle = LocalStrings.current.trashSubtitle,
                    onClick = onOpenTrash,
